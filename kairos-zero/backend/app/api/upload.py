    ...
    try:
        ...
        try:
            ...
            if difficulty == "Très difficile":
                recommendations = [
                    "Préparez-vous avec des entraînements longs en montagne",
                    "Hydratez-vous régulièrement pendant l'effort",
                    "Prévoyez des ravitaillements fréquents",
                    "Entraînez-vous sur des parcours similaires"
                ]
            elif difficulty == "Difficile":
                recommendations = [
                    "Préparez-vous avec des entraînements longs",
                    "Hydratez-vous régulièrement pendant l'effort",
                    "Prévoyez des ravitaillements"
                ]
            elif difficulty == "Modéré":
                recommendations = [
            ...
            return {
                "message": "Fichier GPX uploadé et analysé avec succès",
