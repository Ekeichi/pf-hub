        ...
        <div style={{ maxWidth: '600px', margin: '0 auto', padding: '2rem', textAlign: 'center' }}>
          <div style={{ marginBottom: '3rem' }}>
            ...
            <p style={{ fontSize: '1.1rem', color: 'var(--color-text-secondary)', marginTop: '1rem' }}>
              Votre compte a été créé avec succès. Pour profiter pleinement de Kairos Zero, 
              nous vous recommandons de lier votre compte Strava.
            </p>
          </div>
          ...
          <div style={{ 
            ...
            <ul style={{ 
              ...
              <li style={{ 
                ...
                Synchroniser automatiquement vos activités
              </li>
              <li style={{ 
                display: 'flex', 
                alignItems: 'center', 
                ...
                Obtenir des prédictions de performance précises
              </li>
              <li style={{ 
                display: 'flex', 
                alignItems: 'center', 
