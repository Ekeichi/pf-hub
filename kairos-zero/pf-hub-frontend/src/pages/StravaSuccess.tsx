              ...
              <div style={{ marginTop: '2rem' }}>
                ...
                {result.sync_info && (
                  <div style={{ marginTop: '1rem', textAlign: 'left', background: '#f8f9fa', padding: '1rem', borderRadius: '8px' }}>
                    <p><strong>Activités dans Strava:</strong> {result.sync_info.total_activities_in_strava}</p>
                    <p><strong>Nouvelles activités trouvées:</strong> {result.sync_info.new_activities_found}</p>
                    <p><strong>Activités synchronisées:</strong> {result.sync_info.successfully_synced}</p>
                  </div>
                )}
