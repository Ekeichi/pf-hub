...
def elev_func(file_path, vitesse_plat):
    ...
    k1 = -reg_montee.coef_[0]  # Coefficient négatif dans la régression
    # print(f'v = v0 * exp(-{k1:.3f} * p) uphill')
    ...
    k2 = -reg_descente.coef_[0]  # Coefficient négatif dans la régression
